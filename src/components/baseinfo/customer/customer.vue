	  	...
	  	methods: {
	  		loadData:function(){
	  			...
	  			this.tableData=[{
	  				...
	  				fax:"0571-5689452",
	  				address:"山东省 济南市 高新区 颖秀路 鑫盛大厦",
	  				createdate:"2020-03-15 12:00:00",
	  				state:0,
	  				desc:"该客户租期一年，占用库区为二楼东南。客户行业为电子产品，在京东天猫开店。"
	  			},{
	  				customerNo:"MOR-9078003",
	  				type:"货主",
	  				name:"山东天域食品销售有限公司",
	  				contacts:"墨染",
	  				tel:"13969999999",
